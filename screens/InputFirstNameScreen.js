...
const InputFirstNameScreen = ({navigation}) => {
    ...
    useLayoutEffect(() =>{
        navigation.setOptions({
            ...
            headerRight:() =>{
                return(<TouchableOpacity activeOpacity={0.5} onPress={() => navigation.navigate('patronymic')} ><Text style={{ color: '#0C0C0D', fontSize: 16, fontFamily: "Inter_800ExtraBold" }} >Пропустить</Text></TouchableOpacity>)
            }
        })
    }, [navigation])
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <KeyboardAvoidingView behavior='padding' style={styles.row}>
                ...
                <Button buttonStyle={styles.btn} onPress={() => navigation.navigate('patronymic')} containerStyle={styles.cont_btn} icon={<AntDesign name="arrowright" size={24} color="#F2F2F3" />} />
